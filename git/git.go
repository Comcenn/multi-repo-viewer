...
const DEPENDABOT_QUERY = `{"query": "query { repository(owner: \"%s\", name:\"%s\") { vulnerabilityAlerts(first:20, states: OPEN) { nodes { number state securityVulnerability{ severity }}}}}"}`
